document.getElementById('questionnaire-az-japan').addEventListener('submit', function(e) {
    ...
    const intelligenceDetails = {
        'Verbal-Linqvistik intellekt': [
            ...
            '"Misir tarixi haqqında məlumatlar öyrənib, başqalarına danışarsanmı?"',
            '"Misirin məşhur abidələri və hekayələri haqqında oxumaq və onları qeyd dəftərinə yazmaq maraqlıdırmı?"',
        ...
        'Məntiqi-Riyazi intellekt': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Misir funtunu manata çevirmək və fərqli valyutalar arasındakı əlaqələrin hesablanması nə qədər rahatdır?"',
            '"Qədim Misirdə elm və riyazi bilikləri haqqında öyrənmək maraqlıdırmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
        ...
        'Məkan-vizual intellekti': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Misirin məşhur abidələrinin və yerləşdiyi yerlərin xəritəsini dəqiq formada çəkə bilərsən?"',
            '"Piramida maketini qurmaq və sfinks heykəli ilə işləməkdən zövq aldınmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
        ...
        'Bədən-kinestetik intellekti': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Misir mədəniyyətinə aid oyun və rəqslərdə iştirak etməkdən zövq alarsanmı?"',
            '"Qədim Misir ritual və mərasimlərini canlandırmaqdan zövq alırsınızmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
        ...
        'Musiqi-ritmik intellekt': [
            ...
            '"Musiqi və ritmlər vasitəsilə yeni əsərləe yaratmaq sənin üçün maraqlıdırmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
        ...
        'Şəxslərarası intellekt': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Düşün ki, Misirə səyahət etmisən, orada başqa uşaqlar ilə tanış olub, Yaponiya haqqında danışmaq istəyərdinmi?"',
            '"Qrup halında qədim Misir tapmacalarını həll etməkdən zövq alarsanmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
        ...
        'Şəxsdaxili intellekt': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Qədim Misir fəlsəfəsini və onların dünyagörüşünü öyrənməkdən zövq alırsınızmı?"',
        ...
        'Naturalist intellekt': [
            ...
            { text: 'Müəyyənləşdirici Suallar:', style: 'bold' },
            '"Misirə məxsus müxtəlif bitki və heyvanlar haqqında öyrənmək sənin üçün maraqlıdır?"',
            '"Qədim Misir kənd təsərrüfatı metodlarını və suvarma sistemlərini öyrənmək maraqlı olarmı?"',
            { text: 'İnterpretasiya:', style: 'bold' },
